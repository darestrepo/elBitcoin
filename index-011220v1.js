...
app.post('/', async (req, res) => {
    ...
    switch (action) {
        ...
        case "saludo":
            ...
            let nombreTemporal = req.body.originalDetectIntentRequest.payload.data.from.first_name;
            let buscarTelID = await client.db("bitcoindb").collection("personas")
        ...
        case "si_nombre":
            ...
            let context4 = req.body.queryResult.outputContexts;
            console.log(`nombre ${JSON.stringify(context4)}`); 
        ...
        case "si_ciudad":
            ...
            let context3 = req.body.queryResult.outputContexts;
            console.log(`ciudad ${JSON.stringify(context3)}`); 
        ...
        case "si_pais":
                let context2 = req.body.queryResult.outputContexts;
                console.log(`pais ${JSON.stringify(context2)}`); 
        ...
        case "si_dni":
                let context1 = req.body.queryResult.outputContexts;
                console.log(`dni ${JSON.stringify(context1)}`);  
        ...
        case "si_email":
                let context = req.body.queryResult.outputContexts;
                console.log(`email ${JSON.stringify(context)}`);  
...
/*followupEventInput: {
    ...
    */
        /*case "menu":
            let intencion = req.body.queryResult.action;
            if (intencion === "Confirma datos"){
                const date = await collection.updateOne({telegram_id:telegramID}, {$set: {date:datetime}});                   
            };
            let nombreTemporal = req.body.originalDetectIntentRequest.payload.data.from.first_name;
            let buscarTelID = await client.db("bitcoindb").collection("personas")
